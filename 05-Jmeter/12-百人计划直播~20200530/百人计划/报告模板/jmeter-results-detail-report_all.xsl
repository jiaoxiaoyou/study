    ...
    <xsl:template name="summary">
        ...
        <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <tr valign="top">
                ...
                <xsl:variable name="allFailureCount" select="count(/testResults/httpSample/assertionResult[failure = 'true'])" />
                <xsl:variable name="allSuccessCount" select="count(/testResults/httpSample/assertionResult[failure = 'false'])" />
    ...
    <xsl:template name="pagelist">
        ...
        <table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
            ...
            <xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]">
                ...
                <xsl:variable name="failureCount" select="count(../*[@lb = current()/@lb]/assertionResult[failure = 'true'])" />
                <xsl:variable name="successCount" select="count(../*[@lb = current()/@lb]/assertionResult[failure = 'false'])" />
